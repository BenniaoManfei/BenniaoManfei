...
@XStreamAlias("xml")
public class MsgOutNews extends MsgOut {

	private static final long serialVersionUID = -5702405704477245802L;
	...
	public String toXML() {
		...
		xstream.processAnnotations(MsgOutNews.class);
		xstream.processAnnotations(Item.class);
		return xstream.toXML(this);
	}
	
	public static void main(String[] args) {
		MsgOutNews news = new MsgOutNews() ;
